...
```mdx
<Terminal title="~">## This is markdown Works seamlessly</Terminal>
```
...
```html
<button class="hover:opacity-80" style="background: transparent;"></button>
```
